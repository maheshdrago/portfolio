...
const cards: Card[] = [
  {
    id: "1",
    number: "01",
    title: "Production AI & RAG Engineering",
    description:
      "Building retrieval-augmented generation systems, agentic workflows, prompt pipelines, and evaluation-ready AI applications that connect LLMs with enterprise knowledge sources.",
    skills: [
      "RAG Pipelines",
      "Agentic Systems",
      "LangChain",
  ...
  },
  {
    ...
    description:
      "Designing and shipping user-facing applications with modern frontend frameworks, backend APIs, authentication, database integration, and clean developer-friendly architecture.",
    skills: [
      "React",
      "Next.js",
      "TypeScript",
  ...
  },
  {
    ...
    description:
      "Building cloud-native systems, CI/CD workflows, infrastructure automation, and scalable data pipelines across Azure, AWS, GCP, Spark, Airflow, and Databricks.",
    skills: [
      "Azure",
      "AWS",
      "GCP",
  ...
  },
  {
    ...
    description:
      "Engineering reliable backend services with distributed-system thinking, caching, async processing, search, observability, and production ownership.",
    skills: [
      "Python",
      "Java",
      "Go",
