...
const cards: Card[] = [
  {
    ...
    description: "Building scalable web applications with modern frameworks and best practices, from responsive UIs to robust backend APIs.",
    skills: ["React", "Next.js", "TypeScript", "Node.js", "Django", "Flask", "GraphQL", "Redux"],
  ...
  },
  {
    ...
    number: "02",
    title: "Cloud & DevOps",
    description: "Architecting cloud-native solutions with infrastructure automation, CI/CD pipelines, and containerized deployments.",
    skills: ["AWS", "Docker", "Kubernetes", "Terraform", "CI/CD", "Azure", "GCP"],
  ...
  },
  {
    ...
    description: "Processing massive datasets with distributed computing frameworks and building efficient ETL pipelines for analytics.",
    skills: ["Apache Spark", "Airflow", "PySpark", "Databricks", "ETL", "BigQuery"],
  ...
  },
  {
    ...
    description: "Designing fault-tolerant, scalable architectures with microservices, message queues, and distributed databases.",
    skills: ["Microservices", "PostgreSQL", "MongoDB", "Redis", "Kafka", "gRPC", "WebSockets"],
